...
public class Swagat {
	...
	public static void main(String[] args) {
		...
		File directory = new File("C:\\Users\\Ash\\eclipse-workspace\\");
		...
		System.out.println("*****************************************");
		System.out.println("*******Ashvini ghewande *********************");
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("C:\\Users\\Ash\\eclipse-workspace\\" + filename + ".txt");
			...
			case 3:
				...
				File directory_delete = new File("C:\\Users\\Ash\\eclipse-workspace\\");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C:\\Users\\Ash\\eclipse-workspace\\" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C:\\Users\\Ash\\eclipse-workspace\\");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C:\\Users\\Ash\\eclipse-workspace\\");
